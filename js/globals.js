...
var _a, _SheetInfo_target_id, _SheetInfo_info_sheet_name, _SheetInfo_row_count, _b, _UrlInfo_base_url, _UrlInfo_course_id, _UrlInfo_FA_id, _UrlInfo_question_id, _UrlInfo_url, _UrlInfo_extract_base_url, _UrlInfo_extract_course_id, _UrlInfo_extract_FA_id, _UrlInfo_extract_question_id;
...
class SheetInfo {
    ...
    static async extractTargetID() {
        ...
        console.log(__classPrivateFieldGet(this, _a, "f", _SheetInfo_row_count));
